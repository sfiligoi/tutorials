...
# Enable shared memory handling
# https://docs.cupy.dev/en/stable/user_guide/memory.html#unified-memory-programming-ump-support-experimental
#
# Requires the following env variable to be set
#  export CUPY_ENABLE_UMP=1
#  export HSA_XNACK=1
#
cupy.cuda.set_allocator(cupy.cuda.MemoryPool(cupy.cuda.memory.malloc_system).malloc)

import cupy._core.numpy_allocator as cupy_allocator
import numpy_allocator
import ctypes
lib = ctypes.CDLL(cupy_allocator.__file__)
